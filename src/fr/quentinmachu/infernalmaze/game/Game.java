...
public abstract class Game {
	...
	while (now - lastLoopTime < targetTime) {
	    ...
	    /*
	     * This is optional if we want our game to stop consuming too much CPU but you will loose some accuracy because Thread.sleep(1) could sleep longer than 1 millisecond
	     */
	    try {
		Thread.sleep(1);
